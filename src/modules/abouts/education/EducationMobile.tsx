...
const EducationSection = ({
  ...
  <div className="mt-2 text-start">
    ...
    <ul className="list-disc pl-4 space-y-2 text-lg text-white/60">
...
const EducationMobile = () => {
  ...
  return (
    <div className="flex flex-col text-center">
      <h3 className="text-5xl font-bold my-6">{education.title}</h3>
      <div className="max-w-[350px] w-auto text-white/60 mx-auto">
        <ScrollArea className="h-[300px] rounded-xl">
          ...
          <div className="bg-[#232329] p-6 rounded-xl flex flex-col gap-1 mt-2 shadow-lg">
            ...
            <div className="flex justify-start w-full text-white/60 text-bae flex-wrap">
              <span>{degree}</span>
              <span className="text-primary">{institution}</span>
              <span className="text-end">GPA: {gpa}</span>
            </div>
            {/* Sections */}
