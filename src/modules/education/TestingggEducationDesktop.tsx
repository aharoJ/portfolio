// path: @/modules/education/TestingggEducationDesktop.tsx

import React from "react";
import Image from "next/image";

const TestingggEducationDesktop = () => {
  return (
    <div className="py-12 px-4 max-w-7xl mx-auto">
      ...
      {/* Single Compact Card */}
      <div className="bg-neon-one hover:bg-neon-two p-6 rounded-xl border-4 border-soft-moss transition-all duration-300">
        <div className="flex items-start gap-8">
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center gap-4 mb-3">
              <div className="bg-soft-moss text-creamy-ivory px-2 py-1 rounded-md text-sm font-medium">
                California State University, Dominguez Hills
              </div>
              <div className="text-creamy-bone">Carson, CA • GPA: 3.4</div>
            </div>
            ...
            <div className="flex flex-wrap gap-2 mb-4">
              ...
              <span className="bg-purple-100 text-purple-800 px-3 py-1 rounded-md text-xs font-medium">
                Robotics Program Lead
              </span>
            </div>

            {/* Quick coursework preview */}
            <p className="text-creamy-bone/80 text-sm leading-relaxed">
...
export default TestingggEducationDesktop;
