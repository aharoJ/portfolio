// path: @/modules/experience/TestingggExperienceDesktop.tsx
...
const TestingggExperienceDesktop = () => {
  return (
    // <div className="py-16 px-4 max-w-7xl mx-auto bg-main">
    <div className="py-8 px-4 max-w-7xl mx-auto bg-main">
      ...
      <div className="grid grid-cols-1 gap-16">
        {experiences.map((exp, index) => (
          <div
            ...
            className={`flex items-start gap-12 transition-all duration-300 bg-neon-one hover:bg-neon-two p-8 rounded-xl  
          ...
          >
              ...
              <div className="relative w-64 h-64 overflow-hidden rounded-xl shadow-lg">
                ...
                <div className="absolute inset-0 border-2 border-soft-moss rounded-xl">
                  <Image
                    ...
                    fill
                    sizes="256px"
                    className="object-cover text-creamy-bone bg-neon-one hover:bg-neon-two"
            ...
            <div className="flex-1">
              <div className="flex items-center gap-4 mb-4">
                <div className="bg-soft-moss text-creamy-ivory px-3 py-1 rounded-md text-sm font-medium">
                  {exp.company}
                </div>
                <div className="text-creamy-ivory">{exp.location}</div>
              </div>

              {/* <h3 className="text-2xl font-bold text-soft-moss mb-2"> */}
              <h3 className="text-2xl font-bold text-creamy-bone mb-2">
                {exp.title}
              </h3>
              <p className="text-creamy-bone/70 leading-relaxed mb-4">
                {exp.description}
              </p>
              ...
              <div className="flex gap-2 mt-6">
                {Array.from({ length: 3 }).map((_, i) => (
                  <span
                    key={i}
                    className="text-xs bg-creamy-bone px-3 py-1 rounded-full text-soft-slate"
                  >
                    Skill {i + 1}
                  </span>
                ))}
...
export default TestingggExperienceDesktop;
